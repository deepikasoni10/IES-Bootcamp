...
cd DEG/devkits/p2p-enrollment/install
```
...
3. Open Postman and import the folder `DEG/devkits/p2p-enrollment/postman` to import all collections.
...
```bash
python3 scripts/generate_postman_collection.py --devkit p2p-enrollment --role BAP --output-dir devkits/p2p-enrollment/postman
python3 scripts/generate_postman_collection.py --devkit p2p-enrollment --role BPP --output-dir devkits/p2p-enrollment/postman
```
