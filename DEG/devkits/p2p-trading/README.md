...
cd DEG/devkits/p2p-trading/install
```
...
2. Open postman and import the folder `DEG/devkits/p2p-trading/postman` to import all the collections and environment variables.
...
```bash
python3 scripts/generate_postman_collection.py --devkit p2p-trading --role BAP --output-dir devkits/p2p-trading/postman
python3 scripts/generate_postman_collection.py --devkit p2p-trading --role BPP --output-dir devkits/p2p-trading/postman
python3 scripts/generate_postman_collection.py --devkit p2p-trading --role UtilityBPP --output-dir devkits/p2p-trading/postman
```
