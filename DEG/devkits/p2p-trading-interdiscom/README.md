...
cd DEG/devkits/p2p-trading-interdiscom/install
```
...
python3 scripts/generate_postman_collection.py --devkit p2p-trading-interdiscom --role BAP --output-dir devkits/p2p-trading-interdiscom/postman
python3 scripts/generate_postman_collection.py --devkit p2p-trading-interdiscom --role BPP --output-dir devkits/p2p-trading-interdiscom/postman
```
